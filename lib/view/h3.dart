...
class Hotel_3 extends StatelessWidget {
  const Hotel_3({super.key});
      ...
      body: ListView(
        children: [
          ...
          const Padding(
            ...
            child: Text(
              "The Glass Hotel is a luxurious and contemporary hotel known for its sleek, modern design featuring expansive glass walls that offer stunning views. It combines elegance with comfort, providing guests with a serene atmosphere, exceptional service, and world-class amenities, making it a top choice for those seeking a sophisticated stay.",
