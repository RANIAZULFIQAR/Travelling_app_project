...
class Hotel_1 extends StatelessWidget {
  const Hotel_1({super.key});
      ...
      body: ListView(
        children: [
          ...
          const Padding(
            ...
            child: Text(
              "White Lagoon Restaurant is a dining establishment known for its elegant atmosphere, offering a variety of delicious dishes. It emphasizes quality service and a relaxing environment, making it a great choice for those looking to enjoy a memorable meal.",
