      ...
      body: ListView(
        children: [
          ...
          const Padding(
            ...
            child: Text(
              "Beef steak is a cut of beef, typically from the cow's rib, loin, or sirloin. It is cooked by grilling, pan-searing, or broiling to varying levels of doneness, from rare to well-done. The steak is known for its rich, savory flavor and tender texture, often served with sides like potatoes, vegetables, or sauces.",
