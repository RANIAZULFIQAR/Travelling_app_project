            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    SizedBox(
                      child:buildImageCard(context, 'assets/Alley_palace.png', House(),"Alley Palace",4.5, 150, 60),
                    ),
                    SizedBox(
                      width: 215,
                      child: buildImageCard(context, 'assets/Courdes_Alpes.png', Courdes(),"Courdes Alpes",4.1, 160, 200),
                    ),
                  ],
                ),
              ),
              ...
              SizedBox(
                ...
                child: ListView(
                  scrollDirection: Axis.horizontal,
                  children: [
                    buildSimpleImageCard(context, 'assets/l.png', Luxurious(),"4N/5D", 180, 150),
                    buildSimpleImageCard(context, 'assets/snow.png', Snow(),"2N/3D", 180, 150),
                  ],
                ),
              ),
              const SizedBox(height: 20),
