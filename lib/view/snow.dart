      ...
      body: ListView(
        children: [
          ...
          const Padding(
            ...
            child: Text(
              '"Luxurious Aspen: A majestic retreat set amidst breathtaking landscapes, offering unparalleled elegance and sophistication. With its opulent design and serene surroundings, it provides the ultimate escape into comfort and style."',
