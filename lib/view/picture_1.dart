      ...
      body: ListView(
        children: [
          ...
          const Padding(
            ...
            child: Text(
              'Alley Palace: A hidden gem tucked away in a quiet alley, where the timeless charm of history meets modern elegance, offering a peaceful retreat and a serene escape from the bustling city life."',
