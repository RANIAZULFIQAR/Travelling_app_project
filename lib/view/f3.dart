      ...
      body: ListView(
        children: [
          ...
          const Padding(
            ...
            child: Text(
              "A starter is a small dish served at the beginning of a meal to stimulate the appetite. It can be cold or hot and is often light in texture and flavor. Examples include soups, salads, dips, and finger foods. The purpose of a starter is to prepare the palate for the main course while offering a variety of flavors and textures.",
