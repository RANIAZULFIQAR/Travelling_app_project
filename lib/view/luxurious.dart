...
class Luxurious extends StatelessWidget {
      ...
      body: ListView(
        children: [
          ...
          const Padding(
            ...
            child: Text(
              "Explore Aspen: A breathtaking palace nestled in natures embrace, where stunning beauty meets grandeur, offering a peaceful sanctuary and an unforgettable escape into tranquility.",
